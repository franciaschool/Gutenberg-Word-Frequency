...
#Labels and Inputs
tk.Label(window, text="Enter Book Title:").grid(row=0, column=0, sticky="w")
title_entry = tk.Entry(window, width=50)
title_entry.grid(row=0, column=1)

tk.Label(window, text="Enter Gutenberg .txt URL:").grid(row=1, column=0, sticky="w")
url_entry = tk.Entry(window, width=50)
url_entry.grid(row=1, column=1)

#Buttons
tk.Button(window, text="Search by Title", command=on_search_title).grid(row=2, column=0, pady=5)
tk.Button(window, text="Fetch from URL", command=on_fetch_from_url).grid(row=2, column=1, pady=5)

#Output area
output_area = scrolledtext.ScrolledText(window, width=60, height = 15)
